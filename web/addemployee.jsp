            ...
            <table border="1">
                <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td>Pay Rate:</td>
                        <td><input type="text" name="txtPayRate" id="txtPayRate"  value="" /></td>
                    </tr>  
                    <tr>
                        <td>Start Date:</td>
                        <td><input type="text" name="txtStartDate" id="txtStartDate" value="" /></td>
                    </tr>  
                    <tr>
                        <td>End Date:</td>
                        <td><input type="text" name="txtEndDate" id="txtEndDate"  value="" /></td>
                    </tr>
                    <tr>
